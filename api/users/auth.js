...
export default async function handler(req, res) {
  ...
  if (req.method === "POST") {
    if (req.url === "/api/users/auth/login") {
      // --- Login Logic ---
    ...
    } else if (req.url === "/api/users/auth/register") {
      // --- Register Logic ---
    ...
    } else if (req.url === "/api/users/auth/logout") {
      // --- Logout Logic ---
    ...
    } else if (req.url === "/api/users/auth/resend-verification") {
  ...
  // Handle PUT requests
  if (req.method === "PUT") {
    if (req.url.startsWith("/api/users/auth/verify")) {
      // --- Verify Logic ---
