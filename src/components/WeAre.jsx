        ...
        <div className="row justify-content-center we-are-grid">
          ...
          >
            ...
            <p className="we-are-card-text">
              ...
              تصميمه خصيصًا لدعم المرشحين الطامحين لخوض الانتخابات النيابية
              اللبنانية. هذا البرنامج ليس مجرد مبادرة فردية، بل هو ثمرة جهود
              فريق متكامل من الخبراء، الباحثين السياسيين، صانعي السياسات العامة،
              المدربين، الأخصائيين النفسيين، الاعلاميين، المحامين، وعلماء
              السياسة، الذين عملوا معًا لتطوير محتوى غني وفعّال يلبّي احتياجات
              المرشحين/ات الطموحين/ات. من خلال نهج متكامل يجمع بين التخطيط
              الاستراتيجي، القيادة الشخصية والسياسية، المهارات الإدارية، إدارة
              الحملات، الخطاب السياسي، والتواصل الفعّال، يساعد برنامج المرشّح
              المشاركين على بناء شخصيتهم القيادية، تطوير استراتيجياتهم
              الانتخابية، والتعامل مع التحديات التي تواجههم خلال مسيرتهم
              الانتخابية.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="we-are-card-text">
              ...
              الاستراتيجي، القيادة الشخصية والسياسية، المهارات الإدارية،
              القوانين والدستور اللبناني والنظام الداخلي لمجلس النواب، إدارة
              الحملات، الخطاب السياسي، والتواصل الفعّال. ويهدف إلى تمكين
              المشاركين من بناء هوية قيادية قوية، وضع استراتيجيات انتخابية
              فعالة، والتفاعل بثقة مع الجمهور والناخبين.
            </p>
          </motion.div>
          ...
          >
            ...
            <h2 className="we-are-card-title">
              جهوزية كاملة لخوض الاستحقاق الانتخابي
            </h2>
            <p className="we-are-card-text">
              نحن في <strong>Al Mourachah</strong> نؤمن بأن النجاح في العمل
              النيابي لا يقوم على النوايا الحسنة وحدها، بل يحتاج إلى تأهيل علمي
              وعملي مبني على أسس متينة. لذلك صُمّم برنامج "المرشّح/ة" ليزوّدك
              بالمهارات القيادية، وبناء الصورة الإعلامية، والتحليل الإحصائي
              الدقيق، والمرافقة القانونية المتخصّصة، إضافة إلى الرؤية السياسية
              والاستراتيجية التي تتيح لك التقدّم بخطوات واثقة على منافسيك. مع{" "}
              <strong>Al Mourachah </strong>لن تكون مجرد مرشّح، بل مرشّحًا
              ناجحًا بخطة واضحة وصورة قوية وأرضية صلبة تستند إلى العلم والخبرة.
              هنا يبدأ الفرق بين من يخوض المعركة بالصدفة ومن يخوضها ليربح.
            </p>
          </motion.div>
        </div>
      </div>
