...
const Team = () => {
  ...
  const teamMembers = [
    {
      id: 1,
      name: "ميشال دكّاش",
      role: "مدرّب قيادي ومستشار سياسي",
      image: "/images/t1.jpg",
      description: [
    ...
    },
    {
      id: 3,
      name: "غنوة عطية",
      role: "خبيرة إعلامية ومؤسِّسة شركة Media ID",
      image: "/images/t2.jpg",
      description: [
        "مؤسِّسة شركة Media ID (media-id.co)",
        "حاصلة على إجازة في الصحافة والإعلام",
        "حاصلة على ماجستير في الإعلام والاتصال، بشهادة مزدوجة من الجامعة الأنطونية (لبنان) وجامعة تولون (فرنسا) – ماجستير في العلوم الإنسانية والاجتماعية، اختصاص إعلام واتصال",
    ...
    },
    {
      ...
      description: [
        ...
        "تولّى قيادة فرق إحصائية متخصصة في مشاريع انتخابية بارزة شملت دراسات معمّقة وسيناريوهات خاصة بالقوانين الانتخابية",
        ...
        "يتمتّع بخبرة متميّزة في توظيف البيانات الإحصائية وتحويلها إلى رؤى استراتيجية معمّقة",
      ],
    },
  ];
  ...
  const splitDescription = (description) => {
    ...
    return {
      left: description.slice(0, mid),
      right: description.slice(mid),
    };
  };
